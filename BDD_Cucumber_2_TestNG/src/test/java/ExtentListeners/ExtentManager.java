...
public class ExtentManager {
    ...
    public synchronized static ExtentReports getReporter() {
        if (extent == null) {
	        ...
	        extent.setSystemInfo("Automation Tester", "Krishna");
	        extent.setSystemInfo("Organization", "Automation");
	        extent.setSystemInfo("Build no", "123456");
        }
        return extent;
    }
   ...
   public static String screenshotPath;
	...
	public static void captureScreenshot() {
		i = i + 1;
		File scrFile = ((TakesScreenshot) SeleniumDriverManager.getDriver()).getScreenshotAs(OutputType.FILE);
